    ...
    <div class="user-profile-div" data-aos="fade-left" data-aos-duration="900">
        ...
        <div class="profile-content-div">
            ...
            <div class="btn-div">
                <div class="div-in">
                    <ul>
                        <li class="active" title="Branches" id="branchesPage" onclick="_getActiveBranchPage({divid: 'branchesPage', page: 'branchesPage', url: adminPortalLocalUrl});"><i class="bi-diagram-3"></i> Branches</li>
