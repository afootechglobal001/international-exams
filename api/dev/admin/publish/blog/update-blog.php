...
<?php
    ...
    if ($titleCountQuery>0){ /// start if 4
        ...
        $alertDetail="BLOG UPDATE ATTEMPT FAILED: A staff whose name - ($loginStaffFullname) - (ID: $loginStaffId) attempted to update blog with a name ($regTitle) that is already in use.";	
        goto end;
    }
        ...
        $update ="UPDATE PUBLISH_TAB SET 
            ...
            $response = [
                ...
                'regPix' => $regPix,
                'oldRegPix' => $oldRegPix,
                'message'=> "BLOG UPDATED SUCCESFFULLY!",
                'data' => array() // Initialize the data array
            ];

            $alertDetail = "BLOG UPDATED SUCCESSFULLY: $pageCategoryName was upadated successfully by $loginStaffFullname (ID: $loginStaffId). DETAILS: Title: $regTitle | Blog Category: $blogCatId | ID: $publishId.";
