...
<?php
    ...
    if ($titleCountQuery>0){ /// start if 4
        ...
        $alertDetail="ICT COURSE UPDATE ATTEMPT FAILED: A staff whose name - ($loginStaffFullname) - (ID: $loginStaffId) attempted to update ICT Course with a name ($regTitle) that is already in use.";	
        goto end;
    }
        ...
        $update ="UPDATE PUBLISH_TAB SET 
            ...
            $response = [
                ...
                'regPix' => $regPix,
                'oldRegPix' => $oldRegPix,
                'message'=> "ICT COURSE UPDATED SUCCESFFULLY!",
                'data' => array() // Initialize the data array
            ];

            $alertDetail = "ICT COURSE UPDATED SUCCESSFULLY: $pageCategoryName was upadated successfully by $loginStaffFullname (ID: $loginStaffId). DETAILS: Title: $regTitle | Sub Title: $subTitle | ID: $publishId.";

            // Fetch branch details ///
            $select="SELECT a.pageCategoryId, a.publishId, a.regTitle, a.subTitle, a.regPix, a.statusId, a.createdBy, a.updatedBy, a.createdTme, a.updatedTime, b.statusName FROM PUBLISH_TAB a, SETUP_STATUS_TAB b WHERE a.statusId=b.statusId AND a.pageCategoryId='$pageCategoryId'";
