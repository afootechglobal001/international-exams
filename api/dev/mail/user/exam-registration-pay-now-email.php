...
<div style="width:100%; background:#f4f6f8; padding:30px 0; font-family:Arial, Helvetica, sans-serif;">
    <div style="max-width:700px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.08);">
        ...
        <div style="padding:30px; color:#333;">
            ...
            <h2 style="color:#9d043c; margin-top:0;">Exam Registration Successful</h2>
            ...
            <!-- ================= BIO DATA ================= -->
            <h3 style="color:#9d043c; margin-top:30px;">Bio Data Details</h3>
            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                <tr style="background:#f9fafb;">
            ...
            <!-- ================= EXAM DETAILS ================= -->
            <h3 style="color:#9d043c; margin-top:30px;">Exam Details</h3>
            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
                <tr style="background:#f9fafb;">
             ...
             <!-- ================= DOCUMENTS ================= -->
            <h3 style="color:#9d043c; margin-top:30px;">Uploaded Documents</h3>
            ...
            <!-- ================= SCHOOL OF INTEREST ================= -->
            <h3 style="color:#9d043c; margin-top:30px;">School(s) of Interest</h3>
