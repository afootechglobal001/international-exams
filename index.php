...
<body>
    ...
    <div class="slide-section animated fadeInDown">
        ...
        <script type="text/javascript">
            // List of sentences
            var _CONTENT = ["INTERNATIONAL EXAMINATION CENTERS IN NIGERIA", "15% OFF INTERNATIONAL EXAMS REGISTRATION FEE", "LEARNING MADE EASY WITH OUR PHYSICAL AND ONLINE CLASSES", "GET ADMISSION INTO UNIVERSITY AND COLLEGE ABROAD"];
