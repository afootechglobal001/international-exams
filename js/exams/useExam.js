		...
		<div class="text-div">
			<div class="inner-div">
				...
				<div class="bottom-div">
					<div class="left-div">
						<span class="price">${item.currency === 'USD' ? '$' + thousandSeperator(item.amount) : '<s>N</s>' + thousandSeperator(item.amount)}</span>
		...
		try {
			...
			.then((response) => {
				if (response.success && response.data) {
					...
					$('#examFetchPix').attr('src', (examPixPath ? examPixPath : examRelatedLinkPixPath) + '/' + regPix);
