...
<body>
                ...
                <nav>
                    <ul>
                        ...
                        <a href="<?php echo $websiteUrl ?>/study-abroad">
                            <li title="Study Abroad">Study Abroad <i class="bi bi-caret-right-fill"></i>
                        </a></li>
    ...
    <section class="other-pages-main-section">
        <section class="body-div blog-bg">
                        ...
                        <div class="page-list-back-div">
                            <div class="main-picture-back-div">
                                <div class="main-picture-div" id="studyAbroadPreviewPix">
                                    <img id="studyAbroadFetchPix"
                                        src="<?php echo $websiteUrl?>/uploaded_files/studyAbroad/default.jpg"
                                        alt="Study Abroad" />
                                </div>
            ...
            <script>
            _fetchEachStudyAbroad('<?php echo $publishId?>')
            </script>
        </section>
