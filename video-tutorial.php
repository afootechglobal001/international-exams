...
<head>
    ...
    <title>Videos | International Exams – GRE, TOEFL, ACT, IELTS, GMAT, SAT, CGFNS, PTE, LSAT, MCAT, USMLE, DUOLINGO</title>
                ...
                <nav>
                    <ul>
                        ...
                        <li title="Video Tutorials">
                            <a href="<?php echo $websiteUrl ?>/video-tutorial">
                                Video Tutorials
                            </a>
                        </li>
                    </ul>
            ...
            <div class="other-pages-back-div">
                <div class="main-content-back-div">
                    <div class="text-content-div" data-aos="fade-in" data-aos-duration="900">
                        <h1>Video Tutorials - Subscribe Now!!!</h1>
                        <p>Subscribe to watch any video tutorial of your choice.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="body-div-in">
                <div class="inner-body-div-in">
                    <div class="fetch-ebooks" id="pageContent">
                        <script> _fetchAllVideoData();</script>
